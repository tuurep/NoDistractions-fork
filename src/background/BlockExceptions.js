...
export default {
    createException(tabId, allowedLength) {
        ...
        Utilities.createNotification("visit-anyways-reminder", "You will be allowed to visit blocked sites on this tab for "+allowedLength/60000+" minutes", false);
        ...
        if (excep.allowedLength > 60000) {
            setTimeout(() => {
                ...
                getTab(tabId).then(tabExists => {
                    ...
                    Utilities.createNotification("visit-anyways-reminder", "You have less than one minute remaining on this tab before you get locked out of blocked sites again.", false);
                    setTimeout(() => {
